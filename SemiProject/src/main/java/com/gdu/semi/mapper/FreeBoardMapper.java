...
public interface FreeBoardMapper {
	...
	//public int updateHit(int freeBoardNo);
	public int modifyFree(FreeBoardDTO freeBoard);
	
	
	/*
	 * public List<FreeBoardDTO> selectFreeBoardList(); public int
	 * insertFreeBoard(FreeBoardDTO freeboard); public FreeBoardDTO
	 * selectFreeBoardByNo(int freeboardNo);
	 */
	//public int updateFreeBoard(int freeboardNo);
