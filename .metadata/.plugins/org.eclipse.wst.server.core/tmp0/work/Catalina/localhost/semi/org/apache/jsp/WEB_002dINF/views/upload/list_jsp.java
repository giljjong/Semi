 ...
 * Generated at: 2022-11-27 23:56:26 UTC
...
public final class list_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("					/* <a href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/upload/detail?uploadNo=");
      ...
      out.write("</a> */\r\n");
      out.write("							/* uploadList.uploadTitle */\r\n");
      out.write("							/* .attr('href', '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/upload/detail?uploadNo=') */\r\n");
      out.write("				})\r\n");
      ...
      out.write("				var str = '' ;\r\n");
      out.write("				\r\n");
      out.write("				console.log(resData.beginPage);\r\n");
      out.write("				console.log(resData.endPage);\r\n");
      out.write("				console.log(resData.totalPage); \r\n");
      out.write("				console.log(resData.page); \r\n");
      out.write("				\r\n");
      out.write("			\r\n");
      out.write("			/* 	var str2 = 2;\r\n");
      out.write("				str2.appendTo('#paging'); */\r\n");
      out.write("				 /* str = $('<a>').text('2').attr('href', '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("?page=' + '2' );\r\n");
      out.write("				console.log(str);\r\n");
      out.write("				\r\n");
      out.write("				str.appendTo('#paging');   */\r\n");
      out.write("				\r\n");
      out.write("		 	    if(resData.beginPage != 1){\r\n");
      out.write("					str.append( $('<a>').text('◀').attr('href', '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("?page=' + resData.beginpage -1 ) );\r\n");
      out.write("					\r\n");
      out.write("				}\r\n");
      out.write("				\r\n");
      out.write("			 	for(let p = resData.beginPage; p <= resData.endPage; p++){\r\n");
      out.write("				 	if(p == resData.page){\r\n");
      out.write("				 		$(str).append(p); \r\n");
      out.write("						console.log(p);\r\n");
      out.write("					}  \r\n");
      out.write("					else {\r\n");
      out.write("						$(str).append( $('<a>').text(p).attr('href', '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("?page=' + p ) );\r\n");
      out.write("						console.log(str);\r\n");
      out.write("					} \r\n");
      ...
      out.write("					str.append( $('<a>').text('▶').attr('href', '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("?page=' + resData.endPage+1 ) ) ;\r\n");
      out.write("					console.log(str);\r\n");
      out.write("				}    \r\n");
      out.write("				console.log(str);\r\n");
      out.write("				/*  let p = resData.beginPage\r\n");
      out.write("				 var str2 = '';\r\n");
      out.write("				 str2 = $('<a>').text('◀').attr('href', '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("?page=' + resData.beginpage -1 ) ;\r\n");
      out.write("				 str2.append( $('<a>').text('▶').attr('href', '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("?page=' + resData.endPage+1 ) ); \r\n");
      out.write("				 str2.append( p  ); \r\n");
      out.write("				 str2.append( $('<a>').text(p).attr('href', '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("?page=' + p ) );\r\n");
      out.write("				 console.log(str2);   */\r\n");
      out.write("				 $(str).appendTo('#paging');   \r\n");
      out.write("				\r\n");
      out.write("				\r\n");
      out.write("				\r\n");
