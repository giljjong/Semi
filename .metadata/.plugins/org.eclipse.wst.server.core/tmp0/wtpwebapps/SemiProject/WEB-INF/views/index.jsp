...
<body>
   ...
   <a href="${contextPath}/free/list">자유게시판 가기</a><br>
   <a href="${contextPath}/gallery/list">갤러리게시판 가기</a><br>
   <a href="${contextPath}/upload/list">업로드게시판 가기</a><br>
   <a href="${contextPath}/admin/menu">관리자 페이지 가기</a>
</body>
</html>